...
adminRouter.get('/ownerpending', (req, res) =>
  adminOwnerController.getAllOwnersforVerify(req, res)
);

adminRouter.patch('/customers/updateblockstatus/:userId', (req, res) =>
  adminController.updateCustomerBlockStatus(req, res)
);

adminRouter.patch('/owners/updateblockstatus/:userId', (req, res) =>
  adminOwnerController.updateOwnerBlockStatus(req, res)
);

adminRouter.patch('/owners/updateverifystatus/:userId', (req, res) =>
  adminOwnerController.updateOwnerVerifyStatus(req, res)
);

adminRouter.patch('/cars/updateblockstatus/:carId', (req, res) =>
  adminOwnerController.updateCarBlockStatus(req, res)
);

adminRouter.patch('/cars/updateverifystatus/:carId', (req, res) =>
  adminOwnerController.updateCarVerifyStatus(req, res)
);

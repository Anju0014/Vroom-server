...
complaintRouter.get("/",authMiddleware,(req, res) => complaintController.getMyComplaints(req, res));


complaintRouter.get("/admin",authMiddleware,(req, res) => complaintController.getAllComplaints(req, res));

complaintRouter.patch("/admin/:id",authMiddleware,verifyRole(["admin"]),(req, res) => complaintController.updateComplaintByAdmin(req, res));

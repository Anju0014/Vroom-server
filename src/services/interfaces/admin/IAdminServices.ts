...
export interface IAdminService{
    ...
    listAllCustomers(page: number,limit: number,search: string,): Promise<{customers:ICustomer[], total: number}>
    listAllCarOwners(page: number,limit: number,search: string,): Promise<{carOwners:ICarOwner[], total: number}>
